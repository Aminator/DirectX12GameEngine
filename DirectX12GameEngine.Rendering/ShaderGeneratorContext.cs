...
namespace DirectX12GameEngine.Rendering
{
    public class ShaderGeneratorContext
    {
        ...
        public IComputeShader? Shader { get; private set; }
        ...
        public DescriptorSet? CreateShaderResourceViewDescriptorSet()
        {
            ...
            if (shaderResourceCount > 0)
            {
                ...
                shaderResourceViewDescriptorSet.AddConstantBufferViews(ConstantBufferViews);
                shaderResourceViewDescriptorSet.AddShaderResourceViews(ShaderResourceViews);
                shaderResourceViewDescriptorSet.AddUnorderedAccessViews(UnorderedAccessViews);
        ...
        public DescriptorSet? CreateSamplerDescriptorSet()
        {
            ...
            if (samplerCount > 0)
            {
                DescriptorSet samplerDescriptorSet = new DescriptorSet(GraphicsDevice, samplerCount);
                samplerDescriptorSet.AddSamplers(Samplers);
